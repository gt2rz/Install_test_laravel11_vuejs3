...
<template>
    ...
    >
        ...
        <div class="mb-4 px-4">
            ...
            <div
                class="flex h-10 w-full cursor-pointer items-center rounded-lg bg-gray-200 pl-4 text-blue-400 hover:bg-gray-200"
            >
                <svg class="mr-2 h-6 w-6 fill-current" viewBox="0 0 20 20">
                    <path
            ...
            >
                ...
                <router-link to="/about" class="text-gray-700"
        ...
        <div class="mb-4 px-4">
            <p class="mb-1 pl-4 text-sm font-semibold">PRODUCTS</p>
            <div
                class="flex h-10 w-full cursor-pointer items-center rounded-lg pl-4 text-blue-400 hover:bg-gray-200"
            >
                <svg class="mr-2 h-6 w-6 fill-current" viewBox="0 0 20 20">
        ...
        <div class="mb-4 px-4">
            <p class="mb-1 pl-4 text-sm font-semibold">MISC</p>
            <div
                class="flex h-10 w-full cursor-pointer items-center rounded-lg pl-4 text-blue-400 hover:bg-gray-200"
            >
                <svg class="mr-2 h-6 w-6 fill-current" viewBox="0 0 20 20">
